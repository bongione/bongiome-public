...
function initIndex() {
  ...
  index.add(
      ...
      
      {
        id: 0,
        tag: "en",
        href: "/blog/autism/a_dad_who_knows_little_of_his_son_s_autism/",
        title: "A dad who knows little of his son's autism",
        description: "My son is 7 and I know too little about his autism",
        
        
        content: "My son is seven and a half years old. Earlier, I was thinking about what to write about on this website, and an obvious topic is life as a parent of an autistic child who has severe learning difficulties.\nShame, an old friend who frequently pays a visit, told me that, indeed, I know far too little about autism to talk with any authority about it. I can act as a sample, and some of the tips I discovered or heard may work for other parents, but that\u0026rsquo;s about it.\nSo, bypassing the regrets of my late start on the topic, thanking yet again, my wife for being much more switched on in her role as a parent than I am -she has read and is reading plenty about autism- I promise myself to be better in the months and years to come.\nAnd I want to do it concretely. So the following is my pledge to myself 1, made public to the internet and my friend Shame, for when he visits again in the future:\nToday, I will briefly summarise what I understand of autism, after seven and a half years of parenting our autistic son. I will, in the next three years, gain a better understanding of what the current scientific consensus, thinking and research directions are around autism, especially in terms of what interventions have received empirical support or are looking promising. Once every three months, I will report the progress here and will try to synthesise my findings in a separate section of the website, together with a directory of the resources I\u0026#39;ve discovered during my research. My current understanding of autism \u0026nbsp; I will try to summarise my understanding of autism as of today briefly. When I say this is my current understanding, I need clarification on its validity. Given how little I know about it, it potentially contradicts the current scientific and educational consensus.\nThis summary is informed by:\nMy day-to-day life as a dad with an autistic son. Second-hand knowledge from my diligent wife. Tips and tricks from other parents, educators and health professionals. Minimal reading from parenting books focused on children with autism. Minimal research on Google Scholar about scientific literature around autism. Autism is a condition with a broad spectrum that affects the social and cognitive abilities of a person in several ways:\nUnderdeveloped or hyperdeveloped sensory input Persons with autism often have one or more sensory inputs that are underdeveloped or hyperdeveloped. Our son is a highly sensory-seeking boy who needs frequent, strong feedback from his senses of taste, touch, smell and proprioception. This high need for sensory input is sometimes related to searching for pleasure and other times as a coping mechanism for underlying anxiety. Communication Persons with autism often have difficulty developing their verbal language. Some persons with autism never become verbal; some develop limited verbal ability, while others are perfectly articulate. My son is developing his verbal skills. He can communicate his needs and wants with one or two words and uses a visual communication book to express more complex needs. Sometimes, it is still difficult for him to communicate with us parents about what he feels or needs. Social interaction Persons with autism often find interacting with other people hard, stressful and anxiety-inducing. High-functioning individuals with autism are often mostly affected by this aspect of the autism spectrum and sometimes don\u0026rsquo;t even manifest it outwardly in public spaces. We have heard anecdotes of parents with children in this part of the spectrum saying that their child uses their public persona at school to behave very differently at home, where they can relieve themselves of the stress of living that public persona. Learning difficulties A portion of the population in the autism spectrum has learning disabilities. My son attends a special school, and their curriculum is tailored to each pupil. The pupils\u0026rsquo; curriculum is based on the national UK one. Yet, it differs significantly from the curriculum our daughter, who is ten years old at the moment of writing, followed at my son\u0026rsquo;s age. Challenging behaviour I recently read some statistics about challenging behaviour and autism, and the percentages are relatively high, especially among children with autism who also have learning difficulties. Suppose you are wondering what the term challenging behaviour means in reality. In that case, it is pushing and shoving others, pulling hair, slapping, kicking, throwing things and many other behaviours that you would define naughty, if not worse, to a neurotypical person. For persons with autism, this behaviour is often a form of communication when they are in distress or a consequence of being overwhelmed by the world around them. Mood management Persons with autism often find it difficult to manage their mood. Indeed, the challenging behaviour I mentioned is closely related to the difficulty of finding proper balance. Anxiety and distress are experienced more often than in neurotypical people. As coping mechanisms, many people in the autistic spectrum display repetitive behaviours. Sometimes, this emerges as short, frequent loops of the same sequence of actions repeated over and over again, sometimes in more extended patterns of behaviour that may not be obvious at first glance. As an example, we have recently realised that our son, when visiting a new place, like a holiday home, feels the need to create his own space, his own nest, where he can retire and be undisturbed by others. Once he has that space, he will regularly, during the day, retire to it and prefer to be on his own before coming out to do a new activity. No sense of danger. This is not true for all autistic people, but oh gosh, it is something that affects our family! When discussing autism in general, it probably wouldn\u0026rsquo;t be one of the points that make it to the main bullet point list, but as a parent, keeping my son safe is one of the most stress-inducing and constant struggles for us parents. I said it would be a brief outline so that I will stop here. I could articulate my understanding further, but I have outlined what I believe are the main aspects.\nAs I follow up on my pledge, I intend to articulate more fully on this understanding in the future autism section of the website.\nIf you are puzzled by the fact that I do a pledge, it\u0026rsquo;s based on some tips I read a few years ago. If you want to increase the chances of bringing a project to fruition, announcing it to others may help. It puts some social pressure on yourself. Sounds reasonable. If you do it constantly, does it not dilute its power? Luckily, I\u0026rsquo;ve made similar pledges and promises only a few times.\u0026#160;\u0026#x21a9;\u0026#xfe0e;"
      })
      .add(
      ...
      
      {
        id: 1,
        tag: "en",
        href: "/blog/autism/autistic_holiday_tips/",
        ...
        content: "We spent the half-term break of May 2024 in a holiday village in Belgium, close to where some of our family live. It was fun! It was enjoyable! It was not as relaxing as a week on the shoreline basking in the sun and a good book, but it was fulfilling and nurturing for our family bonds.\nThe holiday is in stark contrast to the previous ones, when we often returned home completely spent, willing the holiday to end on its second day.\nHow did we manage that? Luck and our autistic son\u0026rsquo;s development played a part. But we made two deliberate changes in the run-up to the holiday:\nWe changed our narrative of the holiday. Rather than bracing ourselves for another seven days of survival away from home, we said it was an excellent opportunity to spend quality time with the four of us and the extended family that would be nearby. We used artefact cards to jot down activities we could do to keep our son engaged and happy most of the time. We used three colours: one for me, one for my wife, and one for others/the entire family. The idea was to alternate between carers and use the cards as memory prompts when we were running low on juices. In the end, we only used the cards a little. Still, we did implement the principle of alternating the caregiver and planning the next activity before the current one ran out of fun-generation power. Our son was mainly in the green, and our daughter actively participated in planning and managing her brother\u0026rsquo;s mood. We were often surprised by how smooth and relaxed we felt.\nThese changes were in addition to a few steps we have been doing for a while now:\nWhen visiting family, we always book the same house at the same holiday park. Our son now knows it and is less anxious about being somewhere he doesn\u0026rsquo;t know. We let our son use a part of the house to create his corner, his den, where he goes when he wants to relax and be alone. My wife prepared a visual narrative of the holiday trip we showed before, during, and after. We are planning an Italian summer trip and will face additional challenges. I will let you know how things will work out in early autumn!"
      })
      .add(
      ...
      
      {
        ...
        content: "Hi, I\u0026rsquo;m Paolo Ferdinando Bongiovanni. Thanks for visiting!\nBe warned, most of what follows has my brand of humour: hard to understand - yeah, I\u0026rsquo;m always puzzled that my jokes fall flat- and hard to decide if I\u0026rsquo;m being serious or not. If in doubt, I was probably attempting to be facetious.\nBorn an immigrant, emigration was in the blood early on - 1977/1980 \u0026nbsp; I was born in far 1977, on November 25th. It happened in Belgium, where my mum is from originally. She took the bet of marrying an Italian immigrant 7 year her senior, even after he initially lied about his age.\nAt the time of writing at least, they are still happily married.\nWe lived in Belgium for three years after my birth, welcoming my sister Giusy when I was 2. Then my father received the fateful call from the Italian state railways. He was going to be a train driver!\nThe Italian years - 1980/2002 \u0026nbsp; So we moved to Friuli-Venezia-Giulia. When people ask him where I\u0026rsquo;m from, and I answer Brighton, and they say, no, I mean originally, and I say London, and they say nooo, for gosh sake, hear your accent man, and I eventually relent, I tell them that my parents live in the north-east of Italy, not far from Venice, on the border with Slovenia.\nIt\u0026rsquo;s a lovely part of Italy: it has seaside, mountains, good food, lovely wine. Some may challenge me on the good food part. My wife and I like it, so there you have it.\nThe interesting fact about the place I grew up in is that my dad\u0026rsquo;s family live about as far from there as my mum\u0026rsquo;s family in Belgium. You see, I left something out of my initial telling of the story. Where is my dad from you ask? Think of dead horse\u0026rsquo;s heads in your bed on a cold morning, and you\u0026rsquo;ll have your answer.\nI had a perfectly pleasant and safe childhood, got a second sister called Natalie when I was nine, did well in primary and middle school, started high-school horribly, repeating my first year in a less demanding environment after hitting for the first time the wall between my lazy intelligence and places that required me to abandon that laziness.\nOnce I changed I got back to more acing my classes without much effort till it was time for university. But in those crucial years something very important happened. My inner nerd awoke, consumed me, possessed me. I was an avid tabletop roleplaying player, and I developed my deepest friendships that are still strong nearly 30 years onwards.\nThen it was time for university, where I discovere yet again that being smartish but lazy is not enought when you are surrounded by many brains, a number of them with better hardware, software and switched on more often than yours.\nSo I struggled at university, until I discovered I could go abroad for a period of my student life. And so off off I went, never to look back.\nThe Belgian years - 2002 / 2005 \u0026nbsp; I went back to half of my roots, Belgium, in the ancient university town of Leuven. There I met a lot of amazing friends, some of whom I still frequent 20 years since, and a very special Belgian lady, who lived a couple of miles from where I lived when we were babies. If that\u0026rsquo;s not destiny, what is?!\nHow did I seduce that young lovely lady, who is now my loving wife? The Italian way: food and wine. It\u0026rsquo;s a surprisingly strong combo, it pretty much remains the bedrock of our relationship more than 20 years after it started."
      })
      .add(
      ...
      
      {
        id: 5,
        tag: "en",
        href: "/blog/biases_and_fear_of_biases/",
        ...
        content: "A couple of minutes ago I was thinking about the changes in approach to Mindiply I\u0026rsquo;m thinking about. These days I\u0026rsquo;m also listening to the Decisive audiobook by the Heath brothers, about cognitive biases and decision-making.\nAs I was thinking about it an email came in from the Happy startup school. It was about a few points raised by a chap who does marketing for hippies. A lot of what was said resonated with me and indeed seemed to validate the change in approach I am thinking about - like being genuine, human, and happy to be a fit for some people and not for others.\nAs I had this warm feeling of validation percolating through my body, I mocked, gently, but still mocked myself, telling myself - and this is how confirmation bias happens.\nAnd then I retorted back, are you so afraid of your biases? Are you not only affected by them unconsciously but also let them limit your potential action because you suspect you are triggering them?\nIn the past few years, as I look back on it, I had similar thoughts several times. You take a decision, you look back, and wonder if it is because I\u0026rsquo;m a delusional optimist. I mean, some may argue that if you have a startup that\u0026rsquo;s what you\u0026rsquo;re supposed to be, and you may get a chuckle out of me, because yeah, there is some element of truth, or at least credibility as you say it.\nI am giving myself before taking the plunge with the decision to change how I approach marketing and product discovery in Mindiply because I know I need to attain some distance. I suspect I will probably follow this new direction. One thing I know though, is that this time at least I will take the plunge knowing the risks, and accepting that part of the motivation for doing so is to better motivate myself, and make it more fun as a process."
      })
      .add(
      ...
      
      {
        id: 12,
        tag: "en",
        href: "/blog/startup/pushers_and_pullers/",
        ...
        content: "I\u0026rsquo;m an unrelenting pusher. No, not I don\u0026rsquo;t push drugs. I push my products and ideas to people, instead of looking for their pain points and create solutions to real problems.\nI do believe in the pulling approach. It makes so much sense. I tried doing it. Sincerely. Well, maybe asking my colleagues to do it for me, but I tried for a bit.\nThe big problem is that to do the pulling, you need to conduct the type of activities I don\u0026rsquo;t really enjoy. Network, meet people, build relationships.\nI\u0026rsquo;m ambivert, I don\u0026rsquo;t mind meeting new people, but as an unrelentless habit, far too draining for my lone wolf spirit. So I\u0026rsquo;m deciding to go for broke.\nI will multi-track! Decisive mentions that as a great way to explore multiple options. In terms of a Saas it feels like crazy. The thing is, I spent time and effort to build something, give it a chance to survive. If I buile enough tools, and some people start to use any of the products, some of the others will start to get attention, and maybe also be criticized, or given feeback on.\nI avoid spamming people with stuff they don\u0026rsquo;t care about, only once they start caring they start talking to me.\nI\u0026rsquo;m not saying no marketing at all, content marketing will stay a main stay of what we do.\nMy new motto is value in everything we do. If you land on our pages, I hope you don\u0026rsquo;t go away regretting wasting your time - well unless you were looking for something different, in which case the search engine that didn\u0026rsquo;t understand your search intent is to blame.\nSo my apologies if I push my ideas of what is fun, what is good for you, what works. If a few of you find the tools we build useful, that will be enough for giving our efforts meaning.\nAnd we will definitely listen to you! You don\u0026rsquo;t like how this works, let\u0026rsquo;s dig into why, how can we make it work. We are actually eager to be pulled. But how to kickstart the pulling is the hard part, and we decide to try pushing before you push us back.\nPart of me wonders, am I fooling the sensible part of myself, am I making something sound good to overcome rational objections to such an initiative? Am I convincing myself to be knowingly foolish? Perhaps. Yes, there is a good chance. At least I\u0026rsquo;m testing it out in real life, I\u0026rsquo;m putting some skin in the game. Not so much financially as emotionally and my sense of self-worth.\nBut let\u0026rsquo;s do the 10 - 10 - 10. What will I think of this decision in 10 minutes. I will still feel the positive glow of having taken a decision, lightened, it\u0026rsquo;s done, let\u0026rsquo;s go for it. What will I think in 10 months? I will be either elated, because things are going well, depressed, because I\u0026rsquo;m not going pushed back, or somewhere in between. This will be the less certain. In 10 years? If thing go well, I will still probably be writing similar blog posts and push yet more egotistical ideas onto the defensless rest of humanity. Talk about egomaniacs. If things go badly I will probably be pursuing some other megalomaniac project - perhaps finally writing my fantasy saga of tens of books - and having made of this experience a decision a good anecdote and wisdom to share with friends and family.\nBut I went into it knowing it could go badly. I will suffer if it goes bad, no doubt about it. But if I\u0026rsquo;ve learned anything about my past failures, is that they often brought good learning and eventual good outcomes too. I will write more about the topic at another time."
      })
      .add(
      ...
      
      {
        id: 13,
        tag: "en",
        href: "/tags/pushing-an-pulling/",
        title: "Pushing an Pulling",
        description: "",
